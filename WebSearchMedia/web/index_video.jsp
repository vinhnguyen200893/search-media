                                        ...
                                        <tr>
                                            <td  valign="top">
                                                <table cellspacing="0" cellpadding="2">
                                                    <tr>
                                                        <td align="center">
                                                          <a href="index.jsp"><input type="image" id="music" src="images/music.jpg" align="left" ></a>
                                                            <a href="#">
                                                            <input name="image" type="image" id="film"  src="images/film_on.jpg" align="left">
                                                            </a></td>
                                                    ...
                                                    <tr>
														...
														<td>
															...
															<option value="singer">Tên tác giả </option>
															</select>                  
														</td>
                                                        <td>                                                          
